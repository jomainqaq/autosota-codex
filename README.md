...
```bash
npm install -g https://github.com/jomainqaq/autosota-codex/releases/download/v0.2.1-codex.8/autosota-codex-0.2.1-codex.8.tgz
```

Or install from a local downloaded artifact:

```bash
npm install -g ./autosota-codex-0.2.1-codex.8.tgz
```
...
- `autosota-codex-0.2.1-codex.8.tgz`
- `SHA256SUMS.txt`
