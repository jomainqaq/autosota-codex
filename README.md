...
```bash
npm install -g https://github.com/jomainqaq/autosota-codex/releases/download/v0.2.1-codex.12/autosota-codex-0.2.1-codex.12.tgz
```

Or install from a local downloaded artifact:

```bash
npm install -g ./autosota-codex-0.2.1-codex.12.tgz
```
...
- `autosota-codex-0.2.1-codex.12.tgz`
- `SHA256SUMS.txt`
