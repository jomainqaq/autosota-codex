...
```bash
npm install -g https://github.com/jomainqaq/autosota-codex/releases/download/v0.2.1-codex.9/autosota-codex-0.2.1-codex.9.tgz
```
...
- `autosota-codex-0.2.1-codex.9.tgz`
- `SHA256SUMS.txt`
